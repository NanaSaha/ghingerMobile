  ...
  getgeneralpdsappointments(data) {
    ...
    if (data) {
      ...
      setTimeout(() => {
        ...
        this.data.get_personaldoctorconfirmedearnings(data)
          .then(result => {
            console.log(result);
            ...
            console.log("this.pds_appoint_details " + JSON.stringify(this.pds_appoint_details));
      ...
      buttons: [
        { text: 'No', handler: () => { } },
        {
          ...
          handler: () => {
            ...
            setTimeout(() => {
              this.showalertmessage("Ghinger", "You have requested for funds disbursement to you. Ghinger will contact you shortly before disbursement");
