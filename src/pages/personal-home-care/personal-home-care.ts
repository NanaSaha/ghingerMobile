...
@Component({
  selector: 'page-personal-home-care',
  templateUrl: 'personal-home-care.html',
})
export class PersonalHomeCarePage {
  ...
  submit() {
    ...
    this.data.phone_consult(this.params2).then((result) => {
      ...
      // }
      //  this.viewCtrl.dismiss();
      // this.navCtrl.setRoot(MenuPage, { 'value': this.from_login });
      ...
      if (this.api_code == "000") {
        let alert = this.alertCtrl.create({
          title: '',
          subTitle: "Home Care Appointment made Successfully. You would be contacted shortly. Thank you!",
          buttons: ['OK']
        });
